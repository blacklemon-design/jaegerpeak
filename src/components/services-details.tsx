...
import { ScrollOffsetWrapper } from "./scroll-offset-wrapper"

export async function ServiceDetails({ lang, showBanner }: { lang: Locale, showBanner : boolean }) {
  ...
  const services = [
    {
      ...
      idealFor: [t("service1_idealFor1"), t("service1_idealFor2"), t("service1_idealFor3")],
      frequentGoals: [
    ...
    },
    {
      ...
      idealFor: [t("service2_idealFor1"), t("service2_idealFor2"), t("service2_idealFor3")],
      frequentGoals: [t("service2_frequentGoals1"), t("service2_frequentGoals2"), t("service2_frequentGoals3")],
    },
    {
      ...
      idealFor: [t("service3_idealFor1"), t("service3_idealFor2"), t("service3_idealFor3")],
      frequentGoals: [t("service3_frequentGoals1"), t("service3_frequentGoals2"), t("service3_frequentGoals3")],
    },
    {
  ...
  return (
    <ScrollOffsetWrapper showBanner={showBanner}>
                ...
                <Card className={`bg-card-dark border-card`}>
                  <CardHeader className="text-center pb-8">
                    <div className="flex justify-center mb-4">
                      <Image height={64} width={64} src={service.iconPath || "/placeholder.svg"} alt="athletic icon" />
                    </div>
                  ...
                  <CardContent className="space-y-8">
                        ...
                        <div className="w-full">
                          ...
                          <ul className="space-y-2">
                            {service.frequentGoals.map((frequent, frequentIndex) => (
                              <li key={frequentIndex} className="text-gray-300 flex items-center">
                                <div className="w-1.5 h-1.5 bg-primary rounded-full mr-3 flex-none"></div>
                                {frequent}
                              </li>
                            ))}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-card">
                      <Link href="/#contact" passHref className="w-full">
                        <Button className="flex-1 bg-primary w-full hover:bg-primary text-white">{t("sbutton")}</Button>
                      </Link>
                    </div>
                  </CardContent>
                </Card>
