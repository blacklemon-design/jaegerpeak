        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6 p-10">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link className="text-white" href={"https://www.google.com/maps/place/Widnau,+Switzerland/@47.4033798,9.6267929,4496m/data=!3m1!1e3!4m15!1m8!3m7!1s0x479b169b0d4116ff:0x75a687c7292b9402!2sWidnau,+Switzerland!3b1!8m2!3d47.4055145!4d9.6375563!16zL20vMGdtZzZ4!3m5!1s0x479b169b0d4116ff:0x75a687c7292b9402!8m2!3d47.4055145!4d9.6375563!16zL20vMGdtZzZ4?entry=ttu&g_ep=EgoyMDI1MDkxNy4wIKXMDSoASAFQAw%3D%3D"}>
                Widnau - Schweiz
              </Link>
            </div>
            <div className="flex items-center space-x-4">
              <Phone className="h-5 w-5 text-primary" />
              <Link className="text-white" href={"tel:+41763867705"}>+41 763867705</Link>
            </div>
            <div className="flex items-center space-x-4">
              <Mail className="h-5 w- text-primary" />
              <Link className="text-white" href={"mailto:info@jaegerpeak.ch"}>info@jaegerpeak.ch</Link>
            </div>
